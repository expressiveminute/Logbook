...
object DashboardPrefs {
    ...
    val CATALOG = listOf(
        Tile("flights", R.string.tile_flights, R.drawable.ic_flight, nameSingularRes = R.string.tile_flights_singular),
        Tile("layover", R.string.tile_layover, R.drawable.ic_umbrella),
        Tile("airlines", R.string.tile_airlines, R.drawable.ic_airlines, nameSingularRes = R.string.tile_airlines_singular),
        Tile("aircraft", R.string.tile_aircraft_type, R.drawable.ic_aircraft, nameSingularRes = R.string.tile_aircraft_type_singular),
        ...
        Tile("routes", R.string.tile_routes, R.drawable.ic_routes, nameSingularRes = R.string.tile_routes_singular),
        Tile("airports", R.string.tile_airports, R.drawable.ic_airports),
        Tile("registration", R.string.tile_registration, R.drawable.ic_tag, nameSingularRes = R.string.tile_registration_singular),
        Tile("countries", R.string.tile_countries, R.drawable.ic_countries, nameSingularRes = R.string.tile_countries_singular),
    ...
    val DEFAULT_ROWS = listOf(
        ...
        listOf("airlines", "aircraft", "registration"),
        listOf("countries", "routes", "function"),
        listOf("worldmap"),
    ...
    private const val KEY_TILES = "tiles_standard_v8"
